...
#mysql --local-infile -hlocalhost -u$user taxonnode -p$password --default-character-set=utf8 < import_nodes.sql
...
mysql --defaults-file="/home/lm/tools/blast2hgt/mysql_db/data/my.cnf" --local-infile -hlocalhost -u$user taxondb -p$password <import_nr.acc.taxid.sql
echo DONE 
