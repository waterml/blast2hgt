\! echo 'Loading prot.accession2taxid - this can take a very long time'
DROP TABLE IF EXISTS `prot_accession2taxid`;
...
LOAD DATA LOCAL INFILE '/home/peg/tools/gi2taxid/prot.accession2taxid'
	INTO TABLE prot_accession2taxid
